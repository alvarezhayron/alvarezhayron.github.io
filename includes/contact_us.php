<!-- ***************************************************************************************
    ...
    Program #  : Assignment Purpose/Description 
                 {This is my contact us page which will diaplay the user input for contact info} 
  ...
  **************************************************************************************** -->
<html>
  <head><title> AlvarezH Contact_Us</title></head>
...
<!-- this table is for the time and date -->  
  ...
  <body>
    <form method="post" action="submitController.php">
	  ...
	  <td align="left" width="8%">Telephone </td>
          <td>
              <input type="text" name="Telephone" placeholder="Telehpone" size="35"  maxlength="256">
          </td>
        </tr> 
	  ...
	  <td align="left" width="8%">Last Name </td>
          <td>
            <input type="text" name="LastName" placeholder="Last Name" size="35"  maxlength="256">
          </td>
        </tr> 
	  ...
	  <td>
            <input type="text" name="FirstName" placeholder="First Name" size="35"  maxlength="256">
          </td>
        </tr> 
	  ...
	  <td align="left" width="8%">Email </td>
          <td>
            <input type="text" name="Email" placeholder="Email" size="35"  maxlength="256">
          </td>
        ...
        <tr>
          ...
          <td>
            <textarea placeholder="Comments" name="Comments" rows="5" cols="42"></textarea>
          </td>
        <tr>
